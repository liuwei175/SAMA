...
This folder contains the unified Parkinsons experiment package used to
...
- Dataset: Parkinsons voice data.
- Splits: subject-level train/validation/test splits with seeds
  `20000517, 20000518, 20000617, 20000618`.
- Feature groups: frequency, jitter, shimmer, noise_tone, nonlinear.
- Epsilon grid: `{0.15, 0.25, 0.35}`.
- N grid: `{1, 2, 4, 8, 16, 64, 256}`.
- Stage updates: `500` per N stage.
- Projection: `w in [-1, 1]`.
